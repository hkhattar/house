...
def display(request):
    if request.method=="POST":
        ...
        query="select id, X, Y, FORMAL_PARTICIPANT_NAME, STD_ADDR,HA_PROGRAM_TYPE,STD_CITY,HA_PHN_NUM ,STD_ZIP5 from Public_Housing_Authorities where STD_ST = '{}';".format(statedict[state])
